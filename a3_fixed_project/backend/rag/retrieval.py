...
class DualRetrieval:
    ...
    def dual_search(self, query: str, top_k: int = 10) -> List[Dict]:
        ...
        for result in bm25_results:
            ...
            if text not in combined:
                combined[text] = {"text": text, "bm25_score": 0, "vector_score": 0, "sources": []}
    ...
    def retrieve(self, query: str, top_k: int = 5) -> List[Dict]:
        dual_results = self.dual_search(query, top_k=settings.bm25_top_k + settings.vector_top_k)
